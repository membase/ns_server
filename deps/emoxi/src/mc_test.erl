...
main_mock() ->
    ...
    AsciiPool = mc_pool:create(default,
                               [mc_bucket:create("default", AsciiAddrs,
                                                  Config)]),
    {ns_bootstrap:start(),
