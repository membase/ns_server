    ...
    [{struct,[{blockName,<<"Summary">>},
              {stats,
               [{struct,[{title,<<"ops per second">>},
                         {name,<<"ops">>},
                         {default,true}]},
                {struct,[{title,<<"cache miss %">>},
                         {name,<<"ep_cache_miss_rate">>},
                         {maxY,100}]},
                {struct,[{title,<<"creates per second">>},
                         {name,<<"ep_ops_create">>}]},
                {struct,[{title,<<"updates per second">>},
                         {name,<<"ep_ops_update">>}]},
                {struct,[{title,<<"disk reads">>},
                         {name,<<"ep_bg_fetched">>}]},
     ...
     {struct,[{blockName,<<"vBucket Resources">>},
              ...
              {stats,
               [{struct,[{title,<<"active vBuckets">>},
                         {name,<<"vb_active_num">>}]},
                {struct,[{title,<<"replica vBuckets">>},
                         {name,<<"vb_replica_num">>}]},
                {struct,[{title,<<"pending vBuckets">>},
                         {name,<<"vb_pending_num">>}]},
                {struct,[{title,<<"total vBuckets">>},
                         {name,<<"ep_vb_total">>}]},
                {struct,[{title,<<"active items">>},
                         {name,<<"curr_items">>}]},
                {struct,[{title,<<"replica items">>},
                         {name,<<"vb_replica_curr_items">>}]},
                {struct,[{title,<<"pending items">>},
                         {name,<<"vb_pending_curr_items">>}]},
                {struct,[{title,<<"total items">>},
                         {name,<<"curr_items_tot">>}]},
                {struct,[{title,<<"% resident items">>},
                         {name,
