    ...
    [{struct, [{blockName, <<"Full Text Search Stats: ", Id/binary>>},
               ...
               {stats,
                [{struct, [{title, <<"items">>},
                 ...
                 {struct, [{title, <<"reader multi-gets/sec">>},
                           {name, per_fts_stat(Id, <<"timer_reader_multi_get_count">>)},
                           {desc, <<"Number of reader multi-get ops">>}]},
                 {struct, [{title, <<"reader prefix iterators/sec">>},
                           {name, per_fts_stat(Id, <<"timer_reader_prefix_iterator_count">>)},
                           {desc, <<"Number of reader prefix iterators ops">>}]},
                 {struct, [{title, <<"reader range iterators/sec">>},
                           {name, per_fts_stat(Id, <<"timer_reader_range_iterator_count">>)},
                           {desc, <<"Number of reader range iterators ops">>}]},
                 {struct, [{title, <<"writer batch executes/sec">>},
                           {name, per_fts_stat(Id, <<"timer_writer_execute_batch_count">>)},
                           {desc, <<"Number of writer batch execute ops">>}]},
...
membase_fts_stats_description(_) ->
    [{struct, [{title, <<"fts reader gets/sec">>},
     ...
     {struct, [{title, <<"fts writer batch executes/sec">>},
               {name, global_fts_stat(<<"timer_writer_execute_batch_count">>)},
               {desc, <<"Number of fts writer batch execute ops per second">>}]}].
