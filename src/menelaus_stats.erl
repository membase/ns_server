     ...
     {struct,[{blockName,<<"Upr Queues">>},
              ...
              {stats,
               [{struct,[{title,<<"UPR connections">>},
                ...
                {struct,[{title,<<"UPR connections">>},
                         {name,<<"ep_upr_total_count">>},
                         {desc,<<"Total number of UPR connections in this bucket (measured from ep_upr_total_count)">>}]},
                ...
                {struct,[{title,<<"UPR senders">>},
                         {name,<<"ep_upr_total_producer_count">>},
                         {desc,<<"Total number of senders for this bucket (measured from ep_upr_total_producer_count)">>}]},
                ...
                {struct,[{title,<<"items remaining">>},
                         {name,<<"ep_upr_total_items_remaining">>},
                         {desc,<<"Total number of items remaining to be sent to producer in this bucket (measured from ep_upr_total_items_remaining)">>}]},
                ...
                {struct,[{title,<<"drain rate items/sec">>},
                         {name,<<"ep_upr_total_items_sent">>},
                         {desc,<<"Total number of items per second being sent for a producer for this bucket (measured from ep_upr_total_items_sent)">>}]},
                ...
                {struct,[{title,<<"drain rate bytes/sec">>},
                         {name,<<"ep_upr_total_total_bytes">>},
                         {desc,<<"Total number of bytes per second being sent for all UPR connections for this bucket (measured from ep_upr_total_total_bytes)">>}]}
               ]}]}]
        ++ couchbase_view_stats_descriptions(BucketId)
        ++ couchbase_replication_stats_descriptions(BucketId)
