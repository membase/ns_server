     ...
     {struct,[{blockName,<<"vBucket Resources">>},
              ...
              {stats,
               [{struct,[{title,<<"vBuckets">>},
                ...
                {struct,[{title,<<"vBuckets">>},
                         {name,<<"vb_pending_num">>},
                         {desc,<<"Number of vBuckets in the \"pending\" state for this bucket and should be transient during reblancing (measured from vb_pending_num)">>}]},
                {struct,[{title,<<"vBuckets">>},
                         {name,<<"ep_vb_total">>},
                ...
                {struct,[{title,<<"new items per sec.">>},
                         ...
                         {desc,<<"New items per second being insted into \"pending\" vBuckets in this bucket and should be transient during rebalancing (measured from vb_pending_ops_create)">>},
                         {missing,true}]},
                {struct,[{title,<<"new items per sec.">>},
                         {name,<<"ep_ops_create">>},
              ...
              {stats,
               [{struct,[{title,<<"TAP senders">>},
                ...
                {struct,[{title,<<"fill rate">>},
                         ...
                         {desc,<<"Number of items per second being put on replication TAP queues in this bucket (measured from ep_tap_replica_queue_fill)">>}]},
                {struct,[{title,<<"fill rate">>},
                         {name,<<"ep_tap_rebalance_queue_fill">>},
                         {desc,<<"Number of items per second being put on rebalancing TAP queues in this bucket (measured from ep_tap_rebalance_queue_fill)">>}]},
                {struct,[{title,<<"fill rate">>},
                         {name,<<"ep_tap_user_queue_fill">>},
                         {desc,<<"Number of items per second being put on \"user\" TAP queues in this bucket (measured from ep_tap_user_queue_fill)">>}]},
                {struct,[{title,<<"fill rate">>},
                         {name,<<"ep_tap_total_queue_fill">>},
                         {desc,<<"Total number of items per second being put into TAP queues in this bucket (measured from ep_tap_total_queue_fill)">>}]},
                {struct,[{title,<<"drain rate">>},
              ...
              {stats,
               [{struct,[{name,<<"ops">>},
                ...
                {struct,[{name,<<"evictions">>},
                         {title,<<"RAM evictions per sec.">>}]},
                {struct,[{name,<<"cmd_set">>},
                         {title,<<"Sets per sec.">>}]},
                {struct,[{name,<<"cmd_get">>},
                         {title,<<"Gets per sec.">>}]},
                {struct,[{name,<<"bytes_written">>},
                         {title,<<"Net. bytes TX per sec.">>}]},
                {struct,[{name,<<"bytes_read">>},
                         {title,<<"Net. bytes RX per sec.">>}]},
