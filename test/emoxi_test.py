...
# Before you run emoxi_test.py, start emoxi like...
#
#   erl -pa ebin -s mc_test main_mock
#
# Then...
#
...
class TestProxy(unittest.TestCase):
    def __init__(self, x):
        ...
        # These tests assume an emoxi proxy is running at
        # the self.proxy_port and is forwarding requests
        # to our fake memcached server.
        #
        # TODO: Fork an emoxi proxy like the perl tests.
        #
    ...
    def mock_recv(self, what, session_idx=0):
        ...
        self.assertTrue(what == message or re.match(what, message) is not None,
                        "expected [" + what + "] " + str(len(what)) + "\n" +
                        "got [" + message + "] " + str(len(message)))

        debug(1, "mock_recv done");
