  ...
  function mnSettingsConfig($stateProvider) {
    ...
    $stateProvider
      .state('app.admin.settings', {
        url: '/settings',
        abstract: true,
        templateUrl: 'app-classic/mn_admin/mn_settings/mn_settings.html',
      ...
      .state('app.admin.settings.cluster', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_settings/cluster/mn_settings_cluster.html'
      })
      .state('app.admin.settings.notifications', {
        url: '/notifications',
        controller: 'mnSettingsNotificationsController as settingsNotificationsCtl',
        templateUrl: 'app-classic/mn_admin/mn_settings/notifications/mn_settings_notifications.html',
        data: {
      ...
      .state('app.admin.settings.autoFailover', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_settings/auto_failover/mn_settings_auto_failover.html',
        data: {
          permissions: 'cluster.settings.read'
        }
      })
      .state('app.admin.settings.alerts', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_settings/alerts/mn_settings_alerts.html',
        data: {
          permissions: 'cluster.settings.read'
        }
      })
      .state('app.admin.settings.autoCompaction', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_settings/auto_compaction/mn_settings_auto_compaction.html',
        data: {
          permissions: 'cluster.settings.read'
        }
      })
      .state('app.admin.settings.sampleBuckets', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_settings/sample_buckets/mn_settings_sample_buckets.html',
        data: {
