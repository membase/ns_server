(function () {
  ...
  function mnExternalRolesController($scope, $uibModal, mnLdapService, mnPromiseHelper, mnExternalRolesService, mnPoller, mnHelper, mnSortableTable) {
    ...
    function editUser(user) {
      $uibModal.open({
        templateUrl: 'app-classic/mn_admin/mn_security/mn_external_roles/add_dialog/mn_external_roles_add_dialog.html',
    ...
    function deleteUser(user) {
      $uibModal.open({
        templateUrl: 'app-classic/mn_admin/mn_security/mn_external_roles/delete_dialog/mn_external_roles_delete_dialog.html',
