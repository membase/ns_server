  ...
  function mnInternalRolesController($scope, $uibModal, mnInternalRolesService, mnPromiseHelper, mnHelper) {
    ...
    function deleteUser() {
      return $uibModal.open({
        templateUrl: 'app-classic/mn_admin/mn_security/mn_internal_roles/delete/mn_internal_roles_delete.html',
    ...
    function resetUserPassword() {
      return $uibModal.open({
        templateUrl: 'app-classic/mn_admin/mn_security/mn_internal_roles/reset/mn_internal_roles_reset.html',
