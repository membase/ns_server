  ...
  function mnIndexesConfig($stateProvider, mnHelperProvider) {
    $stateProvider
      .state('app.admin.indexes', {
        ...
        templateUrl: "app-classic/mn_admin/mn_indexes/mn_indexes.html"
      })
      .state('app.admin.indexes.views', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_indexes/mn_views/mn_views.html',
      ...
      .state('app.admin.indexes.views.list', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_indexes/mn_views/list/mn_views_list.html'
      })
      .state('app.admin.indexes.views.editing', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_indexes/mn_views/editing/mn_views_editing.html'
      })
      .state('app.admin.indexes.views.editing.result', {
        ...
        templateUrl: 'app-classic/mn_admin/mn_indexes/mn_views/editing/mn_views_editing_result.html'
      })
      .state('app.admin.indexes.gsi', {
        ...
        templateUrl: "app-classic/mn_admin/mn_indexes/mn_gsi/mn_gsi.html"
      });
  }
