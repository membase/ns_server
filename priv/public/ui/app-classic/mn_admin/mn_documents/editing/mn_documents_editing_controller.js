  ...
  function mnDocumentsEditingController($scope, $state, $uibModal, mnDocumentsEditingService, mnPromiseHelper) {
    ...
    function deleteDocument(documentId) {
      return $uibModal.open({
        ...
        templateUrl: 'app-classic/mn_admin/mn_documents/delete_dialog/mn_documents_delete_dialog.html',
        resolve: {
          documentId: function () {
    ...
    function saveAsDialog() {
      return $uibModal.open({
        ...
        templateUrl: 'app-classic/mn_admin/mn_documents/create_dialog/mn_documents_create_dialog.html',
        resolve: {
          doc: function () {
            return vm.state.doc;
          }
