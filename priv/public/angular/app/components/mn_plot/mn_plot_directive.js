angular.module('mnPlot').directive('mnPlotDirective', function () {
...
(function($) {
  ...
  function plotStatGraph(data, tstamps, options) {
    ...
    var preparedQ = _.prepareQuantity(yTicks[yTicks.length-1], options.isBytes ? 1024 : 1000);
    ...
    var plotOptions = {
      xaxis: {
        ...
        tickFormatter: function (val, axis) {
          ...
          return [_.truncateTo3Digits(val/preparedQ[0]), preparedQ[1]].join('');
        },
        min: 0,
        max: graphMax,
        ticks: yTicks
